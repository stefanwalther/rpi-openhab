...
if [[ $MYOPENHAB_VERSION == "1.4.0-SNAPSHOT" ]]
then
  wget --quiet --no-check-certificate --no-cookies -O /tmp/org.openhab.io.myopenhab-$MYOPENHAB_VERSION.jar https://my.openhab.org/downloads/org.openhab.io.myopenhab-$MYOPENHAB_VERSION.jar
else
  wget --quiet --no-check-certificate --no-cookies -O /tmp/org.openhab.io.myopenhab-$MYOPENHAB_VERSION.jar https://bintray.com/artifact/download/openhab/mvn/org/openhab/io/org.openhab.io.myopenhab/$MYOPENHAB_VERSION/org.openhab.io.myopenhab-$MYOPENHAB_VERSION.jar
fi
...
mv /tmp/org.openhab.io.myopenhab-$MYOPENHAB_VERSION.jar /opt/openhab/addons-available
